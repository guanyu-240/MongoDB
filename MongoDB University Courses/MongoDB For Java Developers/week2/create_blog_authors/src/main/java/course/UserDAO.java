...
public class UserDAO {
    ...
    public boolean addUser(String username, String password, String email) {
        ...
        List<Document> list = usersCollection.find(Filters.eq("_id", username)).into(new ArrayList<Document>());
    ...
    public Document validateLogin(String username, String password) {
        ...
        List<Document> tmp = usersCollection.find(Filters.eq("_id", username)).into(new ArrayList<Document>());
